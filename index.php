                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="<?= isset( $cours['image']) ?  $cours['image'] : ''?>" alt=""></a>
                            </div>

                            <div class="properties__caption">

                                <h3><a href="#"><?= isset( $cours['name']) ?  $cours['name'] : ''?></a></h3>
                                <p><?= isset( $cours['description']) ?  $cours['description'] : ''?> </p>
                                <div class="properties__footer d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="price">
                                        <span>$<?= isset( $cours['price']) ?  $cours['price'] : ''?></span>
                                    </div>
                                </div>
                                <a href="add-student.php" class="border-btn border-btn2">Kursga yozilish</a>
                            </div>
        ...
        <div class="container">
            ...
            <div class="team-active">
                <div class="single-cat text-center">
                    ...
                    <div class="cat-cap">
                        <h5><a href="services.php">Mr. Urela</a></h5>
                        <p>The automated process all your website tasks.</p>
                    </div>
                </div>
                <div class="single-cat text-center">
                    ...
                    <div class="cat-cap">
                        <h5><a href="services.php">Mr. Uttom</a></h5>
                        <p>The automated process all your website tasks.</p>
                    </div>
                </div>
                <div class="single-cat text-center">
                    ...
                    <div class="cat-cap">
                        <h5><a href="services.php">Mr. Shakil</a></h5>
                        <p>The automated process all your website tasks.</p>
                    </div>
                </div>
                <div class="single-cat text-center">
                    ...
                    <div class="cat-cap">
                        <h5><a href="services.php">Mr. Arafat</a></h5>
                        <p>The automated process all your website tasks.</p>
                    </div>
                </div>
                <div class="single-cat text-center">
                    ...
                    <div class="cat-cap">
                        <h5><a href="services.php">Mr. saiful</a></h5>
                        <p>The automated process all your website tasks.</p>
                    </div>
                </div>
            </div>
